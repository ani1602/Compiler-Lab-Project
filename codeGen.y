...
assign_stmt: INIT ID TO E { $$.addr = gen_addr($2); 
            ...
            ; 
initialize_stmt: INIT OPEN_BRACKET ID datatype CLOSE_BRACKET  {$$.code=code_concatenate(2,code_gen(3,$4," ",$3)," ; ");}
                ; 
...
parameter_list: ID datatype {$$.code=code_gen(3,$2," ",$1);}
